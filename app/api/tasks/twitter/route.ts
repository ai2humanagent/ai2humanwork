...
export async function POST(request: Request) {
  ...
  const task: Task = {
    ...
    campaign: {
      ...
      label: config.label,
      targetUrl: targetUrl || `https://x.com/${targetUsername || "ai2humannetwork"}`,
      targetLabel: "Target",
      proofPhrase: "",
      brief: title,
  ...
  const defaultTasks: Task[] = [
    {
      ...
      budget: "0.5",
      deadline: "24h",
      acceptance: "Follow the @ai2humannetwork X account and click Verify to claim your reward.",
      ...
      campaign: {
        ...
        proofPhrase: "",
        brief: "Follow @ai2humannetwork on X",
        proofRequirements: ["Follow @ai2humannetwork on X", "Click Verify to claim your reward"],
        verificationChecks: [],
        submissionFields: []
      },
      status: "created",
    ...
    },
    {
      ...
      campaign: {
        ...
        proofPhrase: "",
        brief: "Like @ai2humannetwork latest post",
    ...
    },
    {
      ...
      campaign: {
        ...
        action: "retweet",
        label: "Repost",
        targetUrl: "https://x.com/ai2humannetwork/status/2021889560729321898",
        targetLabel: "Target post",
        proofPhrase: "",
        brief: "Repost @ai2humannetwork announcement",
