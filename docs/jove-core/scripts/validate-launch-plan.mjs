...
const errors = [];
if (rows.length !== 20) errors.push(`expected 20 launch rows; found ${rows.length}`);
...
console.log("Pilot launch plan valid: 4 retrospective consent blocks, 16 prospective-ready slots.");
