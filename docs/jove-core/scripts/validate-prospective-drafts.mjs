...
const errors = [];
if (drafts.length !== 16) errors.push(`expected 16 prospective drafts; found ${drafts.length}`);
...
console.log("Prospective task drafts valid: 16 draft-only, consent-gated, payout-disabled tasks.");
