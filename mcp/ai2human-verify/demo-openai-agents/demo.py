...
def part2_tool() -> None:
    ...
    ok = json.loads(
        finalize_delivery_fn("ORD-1001", "2026-08-20T12:30:00Z", 31.23, 121.47, f"sha256:{'a' * 64}")
    )
    refused = json.loads(
        finalize_delivery_fn("ORD-9999", "2026-08-20T12:30:00Z", 31.23, 121.47, f"sha256:{'b' * 64}")
    )
